...
namespace SharpD2D.Drawing
{
    ...
    public class LinearGradientBrush : IDisposable, IBrush
    {
        ...
        public PointF Start
        {
            get => _brush.StartPoint;
            set => _brush.StartPoint = value;
        }
        ...
        {
            get => _brush;
            set => _brush = (SharpDXGradientBrush)value;
        }
        ...
        /// </summary>
        /// <param name="start">A PointF structure inclduing the coordinates for the start point of this LinearGradientBrush.</param>
        /// <param name="end">A PointF structure inclduing the coordinates for the end point of this LinearGradientBrush.</param>
        public void SetRange(PointF start, PointF end)
        {
        ...
        /// <returns>
        ///     <see langword="true" /> if <paramref name="obj" /> is a LinearGradientBrush and equal to this instance;
